...
-- This version works without CREATE DATABASE permissions for school servers
-- Make sure you're connected to your assigned database before running this script
