<?php
// PHP code can be added here for dynamic content if needed
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<head><link rel="preload" as="image" href="./assets/images/hero-slider1.jpg"></head>
<link rel="preload" as="image" href="./assets/images/hero-slider-3.jpg"></head>
<body id="top">
<!-- - #PRELOADER-->
...
<span class="span">QuickBite|Mama Tereza's Restaurant,Juba,Sherikaat 8888, SSD</span>
</address>
...
<div class="container">
<a href="#" class="logo">
<img src="./assets/images/logo1.png" width="160" height="80" alt="QuickBite - Home">
</a>
...
<address class="body-4">QuickBite|Mama Tereza's Restaurant,<br>Juba 8888, SSD</address>
<p class="body-4 navbar-text">Open: 5.00 am - 12.00pm</p>
<a href="mailto:booking@quickbite1.com" class="body-4 sidebar-link">booking@quickbite1.com</a>
<div class="separator"></div>
<p class="contact-label">Booking Request</p>
<a href="tel:+211922488868" class="body-1 contact-number hover-underline">+211-9224-88868</a>
</div>
</nav> 
...
<h1 class="display-1 hero-title slider-reveal">Where Taste Reigns  <br>Supreme</h1>
<p class="body-2 hero-text slider-reveal">The Perfect Family Feast</p>
...
<h1 class="display-1 hero-title slider-reveal">From the Earth, to <br>the Table</h1>
<p class="body-2 hero-text slider-reveal">The Perfect Family Feast</p>
<a href="#" class="btn btn-primary slider-reveal">
<span class="text text-1">View Our Menu</span>
<span class="text text-2" aria-hidden="true">View Our Menu</span>
...
<h1 class="display-1 hero-title slider-reveal">Where every Bite <br>tells a story</h1>
<p class="body-2 hero-text slider-reveal">The Perfect Family Feast</p> 
<a href="#" class="btn btn-primary slider-reveal">
<span class="text text-1">View Our Menu</span>
<span class="text text-2" aria-hidden="true">View Our Menu</span>
...
<p class="section-text">We Offer Unmatched Excellence in every dish, defined by Uncompromising Quality, Sensational Flavors, and a passionate commitment to the art of cuisine.</p>
<ul class="grid-list">
<li>
...
<p class="section-text">Every Bite Tells a Story, transforming your meal into an unforgettable,full sensory journey where the meticulous preparation, the freshest ingredients,and the passion for food all converge to write a delicious chapter in your dining memory.</p>
<div class="contact-label">Book Through Call</div>
<a href="tel:+211922488868" class="body-1 contact-number hover-underline">+211 (9224) 888 68</a>
...
<img src="./assets/images/about-banner1.jpg" width="570" height="570" loading="lazy" alt="about banner"class="w-100" data-parallax-item data-parallax-speed="1">
<div class="abs-img abs-img-1 has-before" data-parallax-item data-parallax-speed="1.75">
<img src="./assets/images/about-abs-image1.jpg" width="285" height="285" loading="lazy" alt=""class="w-100">
</div>
...
<div class="container">
<p class="section-subtitle text-center label-2">Chef's Selection</p>
<h2 class="headline-1 section-title text-center">Delicious Menu</h2>
<ul class="grid-list" id="menu-grid">
<li>
<div class="menu-card hover:card">
<figure class="card-banner img-holder" style="--width: 100; --height: 100;">
<img src="./assets/images/menu-1.png" width="100" height="100" loading="lazy" alt="Kibab Salad"class="img-cover">
</figure>
<div>
...
<span class="badge label-1">New Year</span>
<span class="span title-2">SSP 5,500</span>
</div>
...
<div class="menu-card hover:card">
<figure class="card-banner img-holder" style="--width: 100; --height: 100;">
<img src="./assets/images/menu-2.png" width="100" height="100" loading="lazy" alt="Kwaja"class="img-cover">
</figure>
<div>
<div class="title-wrapper">
<h3 class="title-3">
...
<span class="span title-2">SSP 4,500</span>
</div>
...
<div class="menu-card hover:card">
<figure class="card-banner img-holder" style="--width: 100; --height: 100;">
<img src="./assets/images/menu-3.png" width="100" height="100" loading="lazy" alt="Stewed Pumpkin"class="img-cover">
</figure>
<div>
<div class="title-wrapper">
<h3 class="title-3">
...
<span class="span title-2">SSP 5,000</span>
</div>
...
<div class="menu-card hover:card">
<figure class="card-banner img-holder" style="--width: 100; --height: 100;">
<img src="./assets/images/menu-4.png" width="100" height="100" loading="lazy" alt="Grilled Beef"class="img-cover">
</figure>
<div>
<div class="title-wrapper">
<h3 class="title-3">
...
<div class="menu-card hover:card">
<figure class="card-banner img-holder" style="--width: 100; --height: 100;">
<img src="./assets/images/menu-5.png" width="100" height="100" loading="lazy" alt="Stuffed Okra"class="img-cover">
</figure>
<div>
<div class="title-wrapper">
<h3 class="title-3">
...
<div class="menu-card hover:card">
<figure class="card-banner img-holder" style="--width: 100; --height: 100;">
<img src="./assets/images/menu-6.png" width="100" height="100" loading="lazy" alt="Mad Fish"class="img-cover">
</figure>
<div>
<div class="title-wrapper">
<h3 class="title-3">
...
<p class="menu-text text-center">During christmass daily from <span class="span">5:00 pm</span> to <span class="span">12:00 pm</span></p>
<a href="#" class="btn btn-primary">
...
<!-- - #TESTIMONIALS-->
<section class="section testi text-center has-bg-image"style="background-image: url('./assets/images/testimonial2.jpg')" aria-label="testimonials">
<div class="container">
<div class="quote">"</div>
<p class="headline-2 testi-text">I wanted to thank you for having me over for that wonderful dinner the other evening.The meal was truly exceptional.</p>
<div class="wrapper">
<div class="separator"></div>
<div class="separator"></div>
<div class="separator"></div>
...
<div class="profile">
<img src="./assets/images/testi-avatar1.jpg" width="100" height="100" loading="lazy" alt="Sam Jhonson"class="img">
...
<p class="form-text text-center">Booking request <a href="tel:+21192248868" class="link">+211-9224-88868</a>or fill out the order form</p>
...
<address class="body-4">QuickBite | Mama Tereza's Restaurant <br>Juba,Sherikat South Sudan 8888, SSD</address>
<p class="contact-label">Lunch Time</p>
<p class="body-4">Monday to Sunday <br>11.00 am - 4.30pm</p>
<p class="contact-label">Dinner Time</p>
<p class="body-4">Monday to Sunday <br>05.00 pm - 12.00pm</p>
</div>
</div>
</div>
</section>
...
<p class="label-1 card-text">Hygienic food is carefully prepared using clean ingredients and safe cooking practices.</p>
</div>
</li>
<li class="feature-item">
<div class="feature-card">
...
<p class="label-1 card-text">Fresh environment ensures a clean, calm, and welcoming space for every customer.</p>
</div>
</li>
<li class="feature-item">
<div class="feature-card">
...
<p class="label-1 card-text">Skilled chefs prepare delicious meals with expertise, care, and attention to detail.</p>
</div>
</li>
<li class="feature-item">
<div class="feature-card">
...
<div class="container">
<p class="section-subtitle label-2 text-center">Lastest Updates</p>
...
<h3 class="card-title title-2 text-center">Taste so rich you'll crave it before the first bite.</h3>
</div>
</div>
</li>
<li>
<div class="event-card has-before hover:shine">
<div class="card-banner img-holder" style="--width: 350; --height: 450;">
<img src="./assets/images/service4.jpg" width="350" height="450" loading="lazy"alt="Flavour so good you'll try to eat with your eyes." class="img-cover">
<time class="publish-date label-2" datetime="2025-12-12">12/12/2025</time>
</div>
<div class="card-content">
<p class="card-subtitle label-2 text-center">Healthy Food</p>
<h3 class="card-title title-2 text-center">Delicious enough to tempt your eyes and your appetite.</h3>
</div>
</div>
</li>
<li>
...
<h3 class="card-title title-2 text-center">Flavour so good you'll try to eat with your eyes.</h3>
</div>
</div>
</li>
</ul>
...
<p class="section-text text-center">Our talented chefs bring years of culinary expertise and passion to every dish they create.</p>
<ul class="grid-list">
<li>
<div class="chef-card">
<div class="card-banner img-holder" style="--width: 350; --height: 450;">
...
<p class="card-text label-1">With 15 years of experience in fine dining, Chef John specializes in fusion cuisine.</p>
</div>
</div>
</li>
<li>
...
<p class="card-text label-1">Award-winning pastry chef known for her innovative desserts and artistic presentations.</p>
</div>
</div>
</li>
<li>
...
<p class="card-text label-1">Expert in traditional and modern cooking techniques with a passion for local ingredients.</p>
</div>
</div>
</li>
</ul>
...
<p class="section-text">Have questions or special requests? We'd love to hear from you. Reach out to us through any of the channels below.</p>
...
<address class="body-4">QuickBite | Mama Tereza's Restaurant<br>Juba, Sherikaat 8888<br>South Sudan</address>
</div>
</div>
<div class="contact-item">
<div class="icon-wrapper">
...
<a href="mailto:booking@quickbite1.com" class="body-4 contact-link">booking@quickbite1.com</a>
</div>
</div>
<div class="contact-item">
<div class="icon-wrapper">
...
<p class="body-4"><strong>Breakfast:</strong> 5:00 AM - 11:00 AM<br><strong>Lunch:</strong> 11:00 AM - 3:00 PM<br><strong>Dinner:</strong> 5:00 PM - 12:00 AM</p>
</div>
</div>
</div>
</div>
...
<a href="#" class="logo">
<img src="./assets/images/logo1.png" width="160" height="50" loading="lazy" alt="grilli home">
</a>
<address class="body-4">QuickBite | Mama Tereza's Restaurant<br>Juba, Sherikaat 8888, South Sudan</address>
<a href="mailto:quickbite@gmail.com" class="body-4 contact-link">quickbite@gmail.com</a>
<a href="tel:+211922488868" class="body-4 contact-link">Booking Request : +211 9224 888 68</a>
<p class="body-4">Open : 5:00 am - 12:00 pm Daily</p>
<div class="wrapper">
<div class="separator"></div>
<div class="separator"></div>
<div class="separator"></div>
...
<li>
<a href="#chefs" class="label-2 footer-link hover-underline">Our Chefs</a>
</li>
<li>
...
<p class="copyright">&copy; 2025 QuickBite. All Rights Reserved | Crafted by <a href="manyokgchop11@gmail.com"target="_blank" class="link">codewithmanyokgchop11@gmail.com</a></p>
</div>
</div>
</footer>
<!-- - #BACK TO TOP-->
...
<!-- Javascript link - optimized loading order -->
<script src="./assets/js/script.js" defer></script>
<script src="./assets/js/booking.js" defer></script>
<script src="./assets/js/cart-optimized.js" defer></script>
<!--ionicon link - simplified loading -->
...
<body id="top">
  ...
  <header class="header" data-header>
    <div class="container">
      ...
      <a href="auth/login_fixed.php" class="btn btn-secondary">
        <span class="text text-1">Login</span>
      ...
      <section class="section service bg-black-10 text-center" aria-label="service" id="service">
        <div class="container">
          ...
          <p class="section-text">
            At QuickBite, we offer top-notch South Sudanese cuisine that celebrates our rich cultural heritage.
            Our restaurant has been serving authentic traditional dishes since our establishment, bringing you
            the finest flavors from our homeland with modern convenience and exceptional service.
          </p>
      ...
      <section class="section about text-center" aria-label="about label" id="about">
        <div class="container">
          ...
          <div class="about-content">
            ...
            <p class="section-text">
              Every dish at QuickBite tells the story of South Sudanese culture and tradition. From our carefully 
              prepared Kwaja to our signature Grilled Beef, each recipe has been passed down through generations, 
              preserving the authentic flavors that define our heritage. Our chefs combine traditional cooking 
              methods with modern techniques to create an unforgettable dining experience. Whether you're craving 
              our famous Stewed Pumpkin or our delicious Stuffed Okra, every bite connects you to the rich 
              culinary history of South Sudan.
            </p>
      ...
      <section class="special-dish text-center" aria-labelledby="dish-label">
        ...
        <div class="special-dish-content bg-black-10">
          <div class="container">
            ...
            <h2 class="headline-1 section-title">Spicy Noodles</h2>

            <p class="section-text">
              Our signature Spicy Noodles blend traditional South Sudanese spices with perfectly cooked noodles,
              creating a unique fusion dish that has become a customer favorite at QuickBite restaurant.
            </p>

            <div class="wrapper">
              <del class="del body-3">SSP 40.00</del>

              <span class="span body-1">SSP 20.00</span>
            </div>
          ...
          <ul class="grid-list">
            ...
            <li class="feature-item">
              <div class="feature-card">
                ...
                <p class="label-1 card-text">Host your special events and celebrations with our catering services.</p>
  ...
  <footer class="footer section has-bg-image text-center"
    ...
    <div class="container">
      ...
      <div class="footer-bottom">
        ...
        <p class="copyright">
          &copy; 2025 QuickBite. All Rights Reserved | Crafted by <a href="#" target="_blank"
            class="link">codewithmanyokg8@gmail.com</a>
        </p>
