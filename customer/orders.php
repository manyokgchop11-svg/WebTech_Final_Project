...
Check console for detailed info.`);
        ...
        // Test function to add sample items (for testing)
        ...
        // Add refresh button for testing (can be removed later)
        window.refreshCart = refreshCart;
        window.debugCart = debugCart;
        
        // Force cart update on window focus (when returning from login)
